<div class="p-4 max-w-lg mx-auto">
        ...
        <div class="grid grid-cols-2 gap-2">
            @foreach($products as $product)
                <button
                    ...
                    class="p-2 border rounded text-center bg-gray-200">
                ...
                @foreach($cart as $index => $item)
                    <tr class="border-b">
                        ...
                        <td class="p-2 text-center">
                            <button wire:click="updateCart({{ $index }}, 'quantity', {{ $item['quantity'] - 1 }})" class="px-1">-</button>
    ...
    <button
        ...
        class="w-full py-2 bg-blue-500 text-white rounded">Save</button>
